...
public class AsmPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, SILVER_ORE_PLACED_KEY, configuredFeatures.getOrThrow(AsmConfiguredFeatures.OVERWORLD_SILVER_ORE_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(CreateAssembly.MOD_ID, name));
    }
