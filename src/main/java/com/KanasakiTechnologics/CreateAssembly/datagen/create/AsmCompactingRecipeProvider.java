...
public final class AsmCompactingRecipeProvider extends CompactingRecipeGen {
    ...
    GeneratedRecipe ICE_BLOCK = create("ice_block",b -> b.require(Blocks.SNOW_BLOCK).require(Blocks.SNOW_BLOCK).require(Blocks.SNOW_BLOCK).require(Blocks.SNOW_BLOCK).output(Blocks.ICE));
    ...
    //GeneratedRecipe GRAVEL = create("gravel", b -> b.require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).require(Blocks.GRAVEL).output(AsmBlocks.COMPRESSED_GRAVEL));
